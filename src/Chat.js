      ...
      return (
        <KeyboardAvoidingView style={styles.container} behavior='padding'>
          <View style={styles.container}>
            ...
            <StatusBar backgroundColor={Colors.white_color} barStyle='default' hidden={false} translucent={false}
              ...
              >
                <View style={{ backgroundColor: '#f5f4f2', height: 'auto', position: 'absolute', bottom: 0, left: 0, right: 0 }}>
                  <View style={{ paddingTop: 15, paddingHorizontal: 20 }}>
                    <Text style={{ paddingVertical: 10, fontSize: 15.5, fontFamily: 'Ubuntu-Bold', textAlign: 'left' }}>{Lang_chg.chataction[config.language]}</Text>
                    <TouchableOpacity onPress={() => { this.setState({ modalVisible: false }); this.permmissionsendreport() }}>
                      <Text style={{ color: 'black', fontSize: 15, fontFamily: 'Ubuntu-Light' }}>{Lang_chg.chatreport[config.language]}</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={{ paddingVertical: 16 }} onPress={() => { this.setState({ modalVisible: false }); this.permmissionclearchat() }}>
                      <Text style={{ color: 'black', fontFamily: 'Ubuntu-Light', fontSize: 14 }}>{Lang_chg.chatclear[config.language]}</Text>
                    </TouchableOpacity>

                    <TouchableOpacity style={{ paddingBottom: 15 }} onPress={() => { this.setState({ modalVisible: false }) }}>
                      <Text style={{ color: Colors.theme1, fontSize: 15, fontFamily: 'Ubuntu-Light' }}>{Lang_chg.chatcancel[config.language]}</Text>
                    </TouchableOpacity>
                  </View>
            ...
            <View style={{ paddingVertical: 14, backgroundColor: "#d15400", flexDirection: 'row', width: '100%', }}>
              ...
              <View style={{ flexDirection: 'row', alignSelf: 'center', width: '85%', }}>
                <View style={{ flexDirection: 'row', width: '80%' }}>
                  ...
                  {this.state.data.image == undefined ?
                    <Image source={require('./icons/error.png')} style={{ width: 20, alignSelf: 'center', height: 20, resizeMode: 'contain', }} /> :
                ...
                <View style={{ width: '15%', alignItems: 'flex-end', }}>
                  <TouchableOpacity style={{ width: '100%', alignItems: 'flex-end' }} onPressOut={() => { this.setState({ modalVisible: true }) }}>
                    <Image source={require('./icons/dot.png')} style={{ width: 6, height: 24, resizeMode: 'contain' }} />
                  </TouchableOpacity>
                </View>
              </View>
            </View>
                    ...
                    <View style={{ width: '95%', alignSelf: 'center', paddingVertical: 7, }}>
                      {item.userid != this.state.user_id && <View style={{ alignSelf: 'flex-start', width: '70%' }}>
                        <View style={{ backgroundColor: '#d7d7d7', paddingVertical: 1.5, paddingHorizontal: 8, alignSelf: 'flex-start', borderTopStartRadius: 6, borderTopEndRadius: 6, borderBottomLeftRadius: 6 }}>
                          ...
                          {item.messageType == 'image' && <TouchableOpacity >
                            <Image source={{ uri: config.img_url + item.name }} style={{ width: BannerWidth * 42 / 100, height: BannerHieght * 30 / 100, borderRadius: 5, backgroundColor: Color.imagebackcolor }} />
                          </TouchableOpacity>}
                          <Text style={{ fontSize: 14, fontFamily: 'Ubuntu-Light', color: 'gray' }}>{item.time}</Text>
                        </View>
                      </View>}
                      {item.userid == this.state.user_id && <View style={{ width: '70%', alignSelf: 'flex-end', }}>
                        <View style={{ backgroundColor: Colors.theme1, borderTopStartRadius: 6, borderTopEndRadius: 6, borderBottomLeftRadius: 6, paddingVertical: 1.5, paddingHorizontal: 8, alignSelf: 'flex-end' }}>
                          {item.messageType == 'text' && <Text style={{ fontSize: 14, fontFamily: 'Ubuntu-Light', color: '#FFFFFF' }}>{item.name}</Text>}
                          {item.messageType == 'image' && <TouchableOpacity >
                          ...
                          <Text style={{ fontSize: 14, fontFamily: 'Ubuntu-Light', color: '#FFFFFF' }}>{item.time}</Text>
                        </View>
              ...
              {this.state.data.blockstatus == 'no' && <View style={{ paddingHorizontal: 20, width: '100%', alignSelf: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <View style={{ flexDirection: 'row', width: '100%', }}>
                  ...
                  <TextInput
                    ...
                    onFocus={() => { this.setState({ Numberbtn: 1, bottom: 5 }); }}
                    blurOnSubmit={true}
                    scrollEnabled={true}
                    onSubmitEditing={() => { this.setState({ bottom: 0 }) }}
                    style={{ width: '77%', paddingRight: 7, fontFamily: 'Ubuntu-Light', paddingVertical: 8, color: 'black', borderWidth: 1, borderColor: Colors.white_color, borderRadius: 10, paddingHorizontal: 10 }}
                  />
            ...
            >
              <View style={{ backgroundColor: '#f5f4f2', height: 'auto', position: 'absolute', bottom: 0, left: 0, right: 0 }}>
                <View style={{ paddingTop: 15, paddingHorizontal: 20 }}>
                  ...
                  <TouchableOpacity style={{ paddingBottom: 15 }} onPress={() => { this.setState({ modalVisible: false }) }}>
                    <Text style={{ color: 'red', fontSize: 15, fontFamily: 'Ubuntu-Light' }}>{Lang_chg.chatcancel[config.language]}</Text>
                  </TouchableOpacity>
                </View>
            ...
            {this.state.data.blockstatus == 'no' && <View style={{ paddingHorizontal: 20, width: '100%', alignSelf: 'center', flexDirection: 'row', backgroundColor: '#e3e3e3', justifyContent: 'space-between' }}>
              ...
              <View style={{ flexDirection: 'row', width: '100%' }}>
                ...
                <TextInput
                  ...
                  scrollEnabled={true}
                  onSubmitEditing={() => { this.setState({ bottom: 0 }) }}
                  style={{ width: '77%', paddingRight: 6, fontFamily: 'Ubuntu-Light', paddingVertical: 8, color: 'black' }}
                />
                {this.state.chatmsg.length > 0 && <TouchableOpacity style={{ width: '13%', alignSelf: 'center', alignItems: 'flex-end' }} onPress={() => { this.sendmessagebtn() }}>
                  <Image source={require('./icons/send.png')} style={{ width: 25, height: 15, resizeMode: 'contain' }} />

                    ...
                    <FlatList
                          ...
                          renderItem={({item,index})=>{
                              return(
                                  ...
                                  <TouchableOpacity activeOpacity={0.7} onPress={()=>{this.props.navigation.navigate('Boat_detail')}}>
                                    ...
                                    <Image style={styles.main_img_upcoming}  source={require('./icons/upcomint_img.png')}></Image> 
                                    </View>
                                  </View>
                                  </TouchableOpacity>
                              )

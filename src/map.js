...
import { msgProvider, msgTitle, msgText, titlealert } from './Provider/messageProvider';
...
export default class Map_show extends Component {
    ...
    render() {
        return (
            <View style={{ flex: 1, }}>
                <SafeAreaView style={{ flex: 0, backgroundColor: color.theme_color }} />
                <View style={styles.terms_main_view}>
                    ...
                    <View style={{ position: 'absolute', width: '100%',backgroundColor:'#ffffff'}}>
                        ...
                        <TouchableOpacity onPress={this._btnSubmitData}>
                            <Text>{Lang_chg.Done[config.language]}</Text>
                        </TouchableOpacity>
                    </View>
